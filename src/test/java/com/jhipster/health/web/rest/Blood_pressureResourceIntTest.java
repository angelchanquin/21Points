...
import com.jhipster.health.repository.Blood_pressureRepository;
import com.jhipster.health.repository.search.Blood_pressureSearchRepository;
...
public class Blood_pressureResourceIntTest {
    ...
    public void createBlood_pressure() throws Exception {
        ...
        assertThat(testBlood_pressure.getDate()).isEqualTo(DEFAULT_DATE);
    ...
    public void checkSystolicIsRequired() throws Exception {
        int databaseSizeBeforeTest = blood_pressureRepository.findAll().size();
        // set the field null
        blood_pressure.setSystolic(null);
    ...
    public void checkDiastolicIsRequired() throws Exception {
        int databaseSizeBeforeTest = blood_pressureRepository.findAll().size();
        // set the field null
        blood_pressure.setDiastolic(null);
    ...
    public void updateBlood_pressure() throws Exception {
        ...
        Blood_pressure testBlood_pressure = blood_pressureList.get(blood_pressureList.size() - 1);
        assertThat(testBlood_pressure.getDate()).isEqualTo(UPDATED_DATE);
